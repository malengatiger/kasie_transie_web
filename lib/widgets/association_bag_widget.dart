...
class AssociationCountsWidget extends StatefulWidget {
  ...
  @override
  State<AssociationCountsWidget> createState() => _AssociationCountsWidgetState();
}
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                gapW16,
                                TotalWidget(
                                    number: associationCounts!.dispatchRecords!,
                                    width: 160),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              children: [
                                SizedBox(
                                    width: 100,
                                    child:
                                        Text(widget.passengers, style: style)),
                                gapW16,
                                TotalWidget(
                                    number: associationCounts!.passengerCounts!,
                                    width: 160),
                              ],
                            ),
                          ),
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                SizedBox(
                                    width: 100,
                                    child: Text(widget.arrivals, style: style)),
                                gapW16,
                                TotalWidget(
                                    number: associationCounts!.arrivals!, width: 160),
                              ],
                            ),
                          ),
                        ),
                            ...
                            child: Row(
                              children: [
                                SizedBox(
                                    width: 100,
                                    child:
                                        Text(widget.departures, style: style)),
                                gapW16,
                                TotalWidget(
                                    number: associationCounts!.departures!,
                                    width: 160),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              children: [
                                SizedBox(
                                    width: 100,
                                    child:
                                        Text(widget.heartbeats, style: style)),
                                gapW16,
                                TotalWidget(
                                    number: associationCounts!.heartbeats!,
                                    width: 160),
                              ],
                            ),
                          ),
